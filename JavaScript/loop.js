...
function forInLoop() {
    ...
    for (const key in myCar) { //สร้างตัวแปร key เพื่อเก็บชื่อของคุณสมบัติ (property name)
...
function forOfLoop() {
    ...
    for (const color of myColor) { // สร้างตัวแปร color เพื่อเก็บค่าของสมาชิกแต่ละตัวใน array
